...
import com.bearmod.loader.data.model.DownloadStatus
import com.bearmod.loader.data.model.FileType
...
class DownloadActivity : AppCompatActivity() {
    ...
    private fun updateProgressSection(
        ...
        progress: com.bearmod.loader.data.model.DownloadProgress,
        fileType: String
    ) {
        // Update status text
        ...
        progressTextView.text = "${(progress.progress * 100).toInt()}%"
