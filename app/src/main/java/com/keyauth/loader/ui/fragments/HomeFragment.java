...
import com.keyauth.loader.ui.adapter.MainVariantAdapter;
...
public class HomeFragment extends Fragment {
    ...
    private void handleVariantDownload(com.keyauth.loader.data.model.VariantItem variant) {
    ...
    private com.keyauth.loader.data.model.VariantInfo createSampleVariantInfo(long apkSize, long obbSize) {
        // Create sample file info for demonstration
        String timestamp = String.valueOf(System.currentTimeMillis());

        com.keyauth.loader.data.model.FileInfo apkInfo = new com.keyauth.loader.data.model.FileInfo(
        ...
        com.keyauth.loader.data.model.FileInfo obbInfo = new com.keyauth.loader.data.model.FileInfo(
        ...
        return new com.keyauth.loader.data.model.VariantInfo(apkInfo, obbInfo);
    }
    ...
    private void loadVariants() {
        ...
        java.util.List<com.keyauth.loader.data.model.VariantItem> variants = new java.util.ArrayList<>();
